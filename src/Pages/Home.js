...
export function Home(props) {
  ...
  async function handleClick(e) {
    ...
    if (username) {
      ...
      localStorage.setItem("typerex_username", username);
      ...
      <div className="home-content">
        ...
        <div className="home-card">
          <h1 style={{ color: "black" }}>
            <span role="img">⌨️ </span> Welcome to open-source typing platform{" "}
            <span>typerex</span>
          </h1>
          <p className="main-p">
            Open source typing platfrom to find out your words per minute. Start
            the test with any username &nbsp;
            <span role="img">🧡.</span>
          </p>
          <div className="login">
            <section>
              ...
              <form className="form">
                <div className="form-div">
                  ...
                  <input id="uname" className="form-input" type="text"></input>
                </div>
              </form>
              <section
                style={{
  ...
  if (isloggedin) {
      ...
      <>
        ...
        >
          <div className="loading-main">
            ...
            <h2>
              Loading <span className="loading-span"> . </span>
    ...
    return (
      <>
        <div
          className="home"
          style={{ height: "101vh", background: "orangered" }}
        >
          {home}
        </div>
      </>
